...
Anschließend die Konsole öffnen und zu dem Order *.../Battleship-main/out/artifacts/Battleship_jar/* navigieren. 
Nun mittels `java -jar Battleship.jar` die Anwendung starten. 
